...
rst -processor
dow C:/triumf/nuprism/xu1/rev0/SDK_NuPRISM/xu1_nuprism_cmdsvr/Debug/xu1_nuprism_cmdsvr.elf
targets -set -nocase -filter {name =~"MicroBlaze*PMU*" && jtag_cable_name =~ "Platform Cable USB II 00001631dbc501"} -index 0

dow C:/triumf/nuprism/xu1/rev0/SDK_NuPRISM/pmu_fw/Debug/pmu_fw.elf
