...
proc create_root_design { parentCell } {
  ...
  set ps_master_i2c [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 ps_master_i2c ]

  set ps_spi_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 ps_spi_0 ]


  # Create ports
  set adc0_sample [ create_bd_port -dir I -from 31 -to 0 adc0_sample ]
  set adc10_sample [ create_bd_port -dir I -from 31 -to 0 adc10_sample ]
  set adc11_sample [ create_bd_port -dir I -from 31 -to 0 adc11_sample ]
  set adc12_sample [ create_bd_port -dir I -from 31 -to 0 adc12_sample ]
  set adc13_sample [ create_bd_port -dir I -from 31 -to 0 adc13_sample ]
  set adc14_sample [ create_bd_port -dir I -from 31 -to 0 adc14_sample ]
  set adc15_sample [ create_bd_port -dir I -from 31 -to 0 adc15_sample ]
  set adc16_sample [ create_bd_port -dir I -from 31 -to 0 adc16_sample ]
  set adc17_sample [ create_bd_port -dir I -from 31 -to 0 adc17_sample ]
  set adc18_sample [ create_bd_port -dir I -from 31 -to 0 adc18_sample ]
  set adc19_sample [ create_bd_port -dir I -from 31 -to 0 adc19_sample ]
  set adc1_sample [ create_bd_port -dir I -from 31 -to 0 adc1_sample ]
  set adc2_sample [ create_bd_port -dir I -from 31 -to 0 adc2_sample ]
  set adc3_sample [ create_bd_port -dir I -from 31 -to 0 adc3_sample ]
  set adc4_sample [ create_bd_port -dir I -from 31 -to 0 adc4_sample ]
  set adc5_sample [ create_bd_port -dir I -from 31 -to 0 adc5_sample ]
  set adc6_sample [ create_bd_port -dir I -from 31 -to 0 adc6_sample ]
  set adc7_sample [ create_bd_port -dir I -from 31 -to 0 adc7_sample ]
  set adc8_sample [ create_bd_port -dir I -from 31 -to 0 adc8_sample ]
  set adc9_sample [ create_bd_port -dir I -from 31 -to 0 adc9_sample ]
  set adc_sample_valid [ create_bd_port -dir I -from 19 -to 0 adc_sample_valid ]
  set emio_spi0_ss_out [ create_bd_port -dir O emio_spi0_ss_out ]
  set gpio [ create_bd_port -dir O -from 19 -to 0 gpio ]
  set pl_clk1 [ create_bd_port -dir O -type clk pl_clk1 ]
  set pl_resetn0 [ create_bd_port -dir O -type rst pl_resetn0 ]
  set sample_clk [ create_bd_port -dir I -type clk sample_clk ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_DOUT_DEFAULT {0xFFF0FFFF} \
 ...
 ] $axi_gpio_sample_number

  # Create instance: axi_gpio_suppres, and set properties
  set axi_gpio_suppres [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_suppres ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  # Create instance: proc_sys_reset_62p6, and set properties
  set proc_sys_reset_62p6 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_62p6 ]
  ...
  # Create instance: stream_multiplexer_0, and set properties
  set block_name stream_multiplexer
  set block_cell_name stream_multiplexer_0
  if { [catch {set stream_multiplexer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $stream_multiplexer_0 eq "" } {
  ...
  set system_ila_51 [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 system_ila_51 ]
  set_property -dict [ list \
  ...
  # Create instance: system_ila_60, and set properties
  ...
  # Create instance: tlast_generator_1, and set properties
  set block_name tlast_generator
  set block_cell_name tlast_generator_1
  if { [catch {set tlast_generator_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tlast_generator_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: xlslice_07, and set properties
  set xlslice_07 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_07 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {7} \
   CONFIG.DIN_TO {7} \
   CONFIG.DIN_WIDTH {20} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Feedback Clk#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#Gem 0#Gem 0#Gem 0#Gem 0#Gem 0#Gem 0#Gem 0#Gem 0#Gem 0#Gem 0#Gem 0#Gem 0#UART 0#UART 0#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 0#MDIO 0} \
   ...
   CONFIG.PSU__CRF_APB__ACPU_CTRL__ACT_FREQMHZ {599.994019} \
   CONFIG.PSU__CRF_APB__ACPU_CTRL__DIVISOR0 {2} \
   CONFIG.PSU__CRF_APB__ACPU_CTRL__FREQMHZ {600} \
   ...
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__FREQMHZ {25} \
   ...
   CONFIG.PSU__CRL_APB__SDIO1_REF_CTRL__DIVISOR0 {24} \
   ...
   CONFIG.PSU__PROTECTION__DDR_SEGMENTS {SA:0x0; SIZE:2; UNIT:GB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0x0; SIZE:2; UNIT:GB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU1| SA:0x0; SIZE:2; UNIT:GB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU0} \
   CONFIG.PSU__PROTECTION__DEBUG {0} \
   CONFIG.PSU__PROTECTION__ENABLE {0} \
   CONFIG.PSU__PROTECTION__FPD_SEGMENTS {SA:0xFD1A0000; SIZE:1280; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:APU_secure| SA:0xFD1A0000; SIZE:1280; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFD000000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFD010000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFD020000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFD030000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFD040000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFD050000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFD610000; SIZE:512; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFD5D0000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware} \
   CONFIG.PSU__PROTECTION__LOCK_UNUSED_SEGMENTS {0} \
   CONFIG.PSU__PROTECTION__LPD_SEGMENTS {SA:0xFFE00000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFE20000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFE90000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFEB0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF0B0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF0E0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF0A0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF020000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF040000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF050000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF110000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF000000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF9D0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFE200000; SIZE:1024; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFA60000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFA80000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFA90000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFAA0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFAB0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFAC0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFAD0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFAE0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFAF0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFE100000; SIZE:1024; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFE000000; SIZE:1024; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF380000; SIZE:512; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFA50000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFA00000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFA10000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFA30000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFFA20000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF9B0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF9A0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU| SA:0xFF5E0000; SIZE:2560; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:APU_secure| SA:0xFFCC0000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:APU_secure| SA:0xFF180000; SIZE:768; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:APU_secure| SA:0xFFE90000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU1| SA:0xFFEB0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU1| SA:0xFF0B0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF0E0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF0A0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF020000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF160000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF170000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF040000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF050000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF110000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF120000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF130000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF000000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF9D0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFE200000; SIZE:1024; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF980000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF5E0000; SIZE:2560; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFFCC0000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF180000; SIZE:768; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF410000; SIZE:640; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFFA70000; SIZE:64; UNIT:KB; RegionTZ:Secure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFF9A0000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:PMU Firmware| SA:0xFFE00000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU0| SA:0xFFE20000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU0| SA:0xFF000000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU0| SA:0xFF130000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU0| SA:0xFFA60000; SIZE:64; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:RPU0|SA:0xFFA50000 ;SIZE:64;UNIT:KB ;RegionTZ:NonSecure ;WrAllowed:Read/Write;subsystemId:PMU Firmware} \
   CONFIG.PSU__PROTECTION__MASTERS {USB1:NonSecure;0|USB0:NonSecure;1|S_AXI_LPD:NA;0|S_AXI_HPC1_FPD:NA;1|S_AXI_HPC0_FPD:NA;1|S_AXI_HP3_FPD:NA;0|S_AXI_HP2_FPD:NA;0|S_AXI_HP1_FPD:NA;0|S_AXI_HP0_FPD:NA;0|S_AXI_ACP:NA;0|S_AXI_ACE:NA;0|SD1:Secure;1|SD0:NonSecure;1|SATA1:NonSecure;0|SATA0:NonSecure;0|RPU1:NonSecure;1|RPU0:NonSecure;1|QSPI:NonSecure;1|PMU:NA;1|PCIe:NonSecure;0|NAND:NonSecure;0|LDMA:NonSecure;1|GPU:NonSecure;1|GEM3:NonSecure;1|GEM2:NonSecure;0|GEM1:NonSecure;0|GEM0:NonSecure;1|FDMA:NonSecure;1|DP:NonSecure;0|DAP:NA;1|Coresight:NA;1|CSU:NA;1|APU:NA;1} \
   CONFIG.PSU__PROTECTION__MASTERS_TZ {GEM0:NonSecure|SD1:Secure|GEM2:NonSecure|GEM1:NonSecure|GEM3:NonSecure|PCIe:NonSecure|DP:NonSecure|NAND:NonSecure|GPU:NonSecure|RPU1:NonSecure|RPU0:NonSecure|SATA0:NonSecure|SATA1:NonSecure|USB1:NonSecure|USB0:NonSecure|LDMA:NonSecure|FDMA:NonSecure|QSPI:NonSecure|SD0:NonSecure} \
   CONFIG.PSU__PROTECTION__OCM_SEGMENTS {SA:0xFFFC0000; SIZE:256; UNIT:KB; RegionTZ:NonSecure; WrAllowed:Read/Write; subsystemId:APU_secure} \
   ...
   CONFIG.PSU__PROTECTION__SUBSYSTEMS {APU:GEM0;SD1;GEM3;APU;DAP|APU_secure:SD1;APU;CSU;PMU|RPU1:RPU1;DAP|PMU Firmware:PMU|RPU0:RPU0;DAP} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_50/SLOT_3_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_MM2S] [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins system_ila_50/SLOT_1_AXI]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_SG [get_bd_intf_pins axi_dma_1/M_AXI_SG] [get_bd_intf_pins smartconnect_1/S00_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_clock_converter_0_M_AXIS] [get_bd_intf_pins axis_clock_converter_0/M_AXIS] [get_bd_intf_pins system_ila_50/SLOT_4_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_clock_converter_0_M_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_1_M_AXIS [get_bd_intf_pins axis_clock_converter_1/M_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_clock_converter_1_M_AXIS] [get_bd_intf_pins axis_clock_converter_1/M_AXIS] [get_bd_intf_pins system_ila_50/SLOT_5_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_clock_converter_1_M_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_0_M_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins system_ila_50/SLOT_6_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_interconnect_0_M00_AXIS] [get_bd_intf_pins axis_interconnect_0/M00_AXIS] [get_bd_intf_pins system_ila_50/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins axis_clock_converter_0/S_AXIS] [get_bd_intf_pins tlast_generator_0/m_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_subset_converter_0_M_AXIS] [get_bd_intf_pins axis_clock_converter_0/S_AXIS] [get_bd_intf_pins system_ila_51/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins axi_gpio_suppres/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_1_M00_AXI] [get_bd_intf_pins smartconnect_1/M00_AXI] [get_bd_intf_pins system_ila_50/SLOT_7_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets smartconnect_1_M00_AXI]
  connect_bd_intf_net -intf_net tlast_generator_1_m_axis [get_bd_intf_pins axis_clock_converter_1/S_AXIS] [get_bd_intf_pins tlast_generator_1/m_axis]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_IIC_0 [get_bd_intf_ports ps_master_i2c] [get_bd_intf_pins zynq_ultra_ps_e_0/IIC_0]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_SPI_0 [get_bd_intf_ports ps_spi_0] [get_bd_intf_pins zynq_ultra_ps_e_0/SPI_0]

  # Create port connections
  connect_bd_net -net aclk_0_1 [get_bd_ports sample_clk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_clock_converter_1/s_axis_aclk] [get_bd_pins proc_sys_reset_62p6/slowest_sync_clk] [get_bd_pins stream_multiplexer_0/clk_sample] [get_bd_pins system_ila_51/clk] [get_bd_pins tlast_generator_0/clk] [get_bd_pins tlast_generator_1/clk]
  connect_bd_net -net adc0_sample_0_1 [get_bd_ports adc0_sample] [get_bd_pins stream_multiplexer_0/adc0_sample]
  connect_bd_net -net adc10_sample_0_1 [get_bd_ports adc10_sample] [get_bd_pins stream_multiplexer_0/adc10_sample]
  connect_bd_net -net adc11_sample_0_1 [get_bd_ports adc11_sample] [get_bd_pins stream_multiplexer_0/adc11_sample]
  connect_bd_net -net adc12_sample_0_1 [get_bd_ports adc12_sample] [get_bd_pins stream_multiplexer_0/adc12_sample]
  connect_bd_net -net adc13_sample_0_1 [get_bd_ports adc13_sample] [get_bd_pins stream_multiplexer_0/adc13_sample]
  connect_bd_net -net adc14_sample_0_1 [get_bd_ports adc14_sample] [get_bd_pins stream_multiplexer_0/adc14_sample]
  connect_bd_net -net adc15_sample_0_1 [get_bd_ports adc15_sample] [get_bd_pins stream_multiplexer_0/adc15_sample]
  connect_bd_net -net adc16_sample_0_1 [get_bd_ports adc16_sample] [get_bd_pins stream_multiplexer_0/adc16_sample]
  connect_bd_net -net adc17_sample_0_1 [get_bd_ports adc17_sample] [get_bd_pins stream_multiplexer_0/adc17_sample]
  connect_bd_net -net adc18_sample_0_1 [get_bd_ports adc18_sample] [get_bd_pins stream_multiplexer_0/adc18_sample]
  connect_bd_net -net adc19_sample_0_1 [get_bd_ports adc19_sample] [get_bd_pins stream_multiplexer_0/adc19_sample]
  connect_bd_net -net adc1_sample_1 [get_bd_ports adc1_sample] [get_bd_pins stream_multiplexer_0/adc1_sample]
  connect_bd_net -net adc2_sample_1 [get_bd_ports adc2_sample] [get_bd_pins stream_multiplexer_0/adc2_sample]
  connect_bd_net -net adc3_sample_0_1 [get_bd_ports adc3_sample] [get_bd_pins stream_multiplexer_0/adc3_sample]
  connect_bd_net -net adc4_sample_0_1 [get_bd_ports adc4_sample] [get_bd_pins stream_multiplexer_0/adc4_sample]
  connect_bd_net -net adc5_sample_0_1 [get_bd_ports adc5_sample] [get_bd_pins stream_multiplexer_0/adc5_sample]
  connect_bd_net -net adc6_sample_0_1 [get_bd_ports adc6_sample] [get_bd_pins stream_multiplexer_0/adc6_sample]
  connect_bd_net -net adc7_sample_0_1 [get_bd_ports adc7_sample] [get_bd_pins stream_multiplexer_0/adc7_sample]
  connect_bd_net -net adc8_sample_0_1 [get_bd_ports adc8_sample] [get_bd_pins stream_multiplexer_0/adc8_sample]
  ...
  connect_bd_net -net axi_gpio_suppres_gpio_io_o [get_bd_pins axi_gpio_suppres/gpio_io_o] [get_bd_pins stream_multiplexer_0/gpio] [get_bd_pins system_ila_60/probe0] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_gpio_suppres_gpio_io_o]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_sample_number/s_axi_aresetn] [get_bd_pins axi_gpio_suppres/s_axi_aresetn] [get_bd_pins proc_sys_reset_100/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins system_management_wiz_0/s_axi_aresetn]
  ...
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets s_axis_tdata_0_1]
  connect_bd_net -net s_axis_tvalid_0_1 [get_bd_pins stream_multiplexer_0/adc_sample_valid_selected_0] [get_bd_pins system_ila_51/probe0] [get_bd_pins tlast_generator_0/data_enable]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets s_axis_tvalid_0_1]
  connect_bd_net -net stream_multiplexer_0_adc_sample_selected_1 [get_bd_pins stream_multiplexer_0/adc_sample_selected_1] [get_bd_pins system_ila_51/probe2] [get_bd_pins tlast_generator_1/data]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets stream_multiplexer_0_adc_sample_selected_1]
  ...
  connect_bd_net -net tlast_generator_0_triger_test [get_bd_pins system_ila_51/probe5] [get_bd_pins tlast_generator_0/triger_test]
  connect_bd_net -net tlast_generator_1_counter [get_bd_pins system_ila_51/probe4] [get_bd_pins tlast_generator_1/counter]
  connect_bd_net -net tlast_generator_1_triger_test [get_bd_pins system_ila_51/probe6] [get_bd_pins tlast_generator_1/triger_test]
  ...
  connect_bd_net -net xlslice_2_Dout1 [get_bd_pins tlast_generator_0/triger] [get_bd_pins tlast_generator_1/triger] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins tlast_generator_0/triger_enable] [get_bd_pins tlast_generator_1/triger_enable] [get_bd_pins xlslice_3/Dout]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_LPS_OCM] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_QSPI] -force
