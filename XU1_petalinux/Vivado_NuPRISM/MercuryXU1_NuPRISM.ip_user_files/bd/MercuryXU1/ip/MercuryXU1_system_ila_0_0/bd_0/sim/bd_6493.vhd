...
entity bd_6493 is
  ...
  attribute CORE_GENERATION_INFO of bd_6493 : entity is "bd_6493,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_6493,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of bd_6493 is
  ...
  port (
    ...
    m_slot_1_axis_tdest : out STD_LOGIC_VECTOR ( 4 downto 0 )
  );
  end component bd_6493_g_inst_0;
  signal Conn1_TDATA : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal Conn1_TDEST : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  signal net_slot_1_axis_tdest : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN MercuryXU1_zynq_ultra_ps_e_0_0_pl_clk3, FREQ_HZ 299997009, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
  ...
  attribute X_INTERFACE_PARAMETER of SLOT_1_AXIS_tdata : signal is "XIL_INTERFACENAME SLOT_1_AXIS, CLK_DOMAIN MercuryXU1_zynq_ultra_ps_e_0_0_pl_clk3, FREQ_HZ 299997009, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 4, TDEST_WIDTH 5, TID_WIDTH 0, TUSER_WIDTH 0";
...
begin
  ...
  Conn1_TDEST(4 downto 0) <= SLOT_1_AXIS_tdest(4 downto 0);
...
g_inst: component bd_6493_g_inst_0
     port map (
      ...
      m_slot_1_axis_tdest(4 downto 0) => net_slot_1_axis_tdest(4 downto 0),
      ...
      slot_1_axis_tdest(4 downto 0) => Conn1_TDEST(4 downto 0),
...
ila_lib: component bd_6493_ila_lib_0
     port map (
      ...
      probe6(4 downto 0) => net_slot_1_axis_tdest(4 downto 0),
      probe7(3 downto 0) => net_slot_1_axis_tkeep(3 downto 0),
