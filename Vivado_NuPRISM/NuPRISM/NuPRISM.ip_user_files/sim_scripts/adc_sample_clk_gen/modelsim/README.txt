...
#
# Generated by export_simulation on Tue Apr 20 11:03:55 PDT 2021
#
################################################################################
...
'-reset_run' switch to the './adc_sample_clk_gen.sh' script.

./adc_sample_clk_gen.sh -reset_run
...
./adc_sample_clk_gen.sh -noclean_files

For more information on the script, please type './adc_sample_clk_gen.sh -help'.
