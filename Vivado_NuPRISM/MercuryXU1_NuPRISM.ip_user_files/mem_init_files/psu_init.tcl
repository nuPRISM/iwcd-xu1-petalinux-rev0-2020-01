...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01011802
    ...
    mask_write 0XFF5E009C 0x01003F07 0x01000500
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01011802
    ...
    mask_write 0XFF5E00C8 0x013F3F07 0x01013002
    ...
    mask_write 0XFF5E00CC 0x013F3F07 0x01010402
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
    ...
    mask_write 0XFD1A0060 0x03003F07 0x03000200
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x03BFFF9E
    ...
    mask_write 0XFF180148 0x03FFFFFF 0x03000F00
    ...
    mask_write 0XFF180144 0x03000F00 0x03000F00
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FFDFC0
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x000000FC
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03FFE03F
    ...
    mask_write 0XFF180160 0x000FC000 0x000FC000
    ...
    mask_write 0XFF18017C 0x03000FFF 0x03000FFF
    ...
    mask_write 0XFF180180 0x03FFFFFF 0x03000FFF
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF5E0238 0x00003800 0x00000000
		# : UART
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
...
set psu_apply_master_tz {
    ...
    mask_write 0XFF4B0020 0x00000003 0x00000003
		# : DP TZ
    ...
    mask_write 0XFF240004 0x003F0000 0x00020000
    ...
    mask_write 0XFF240000 0x003F0000 0x00020000
		# : GEM TZ
		# Register : IOU_AXI_RPRTCN @ 0XFF240004</p>
